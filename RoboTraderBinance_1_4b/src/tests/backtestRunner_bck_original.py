...
def backtestRunner(
    ...
    **strategy_kwargs
    ...
    start_date = stock_data['open_time'].min()
    end_date = stock_data['open_time'].max()
    ...
    for i in range(1, len(stock_data)):
        ...
        if signal and position == 0 and last_signal != "buy":
            ...
            last_signal = "buy"; stock_data.loc[i, 'acao_tomada'] = last_signal
            trades += 1
        ...
        # Venda apenas no primeiro sinal de venda e se estiver comprado
            ...
            balance += profit
            last_signal = "sell"; stock_data.loc[i, 'acao_tomada'] = last_signal
            trades += 1

    print(stock_data['acao_tomada'].value_counts(), '\n')
    ...
    print(stock_data[stock_data['acao_tomada'].notnull()])
