...
def getRsiTradeStrategy(stock_data: pd.DataFrame, period=14, low=30, high=70, verbose=True):
    """
    ...
    Args:
        ...
        low: Nível de sobrevenda (padrão: 30)
        high: Nível de sobrecompra (padrão: 70)
    ...
    stock_data["RSI"] = Indicators.getRSI(stock_data["close_price"], window=period, last_only=False)
